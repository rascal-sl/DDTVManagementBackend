...
router.get('/statuses', authenticateToken, authorizeRoles('super_admin'), statusCtrl.getStatuses);
...
router.get('/issues', authenticateToken, authorizeRoles('super_admin'), issueCtrl.getIssues);
